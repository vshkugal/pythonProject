...
class Car(multiprocessing.Process):
    ...
    def run(self):
        ...
        if not self.parking.acquire(timeout=self.waiting_time):
...
if __name__ == '__main__':
    ...
    # parking = multiprocessing.Manager().Semaphore(value=number_of_parking_places)
    # parking = multiprocessing.Manager().BoundedSemaphore(value=number_of_parking_places)
    # parking = multiprocessing.Semaphore(value=number_of_parking_places)
    parking = multiprocessing.BoundedSemaphore(value=number_of_parking_places)

...
class Dropdown(BaseElement):
    ...
    OPTION = "//select[@id = '{}']/option[text() = '{}']"
    SELECTED_OPTION = "//select[@id = '{}']/option[@selected = 'selected']"
    ALL_OPTIONS = "//select[@id = '{}']/option"
    ...
    def get_selected(self):
        return str(self.driver.find_element(By.XPATH, Dropdown.SELECTED_OPTION.format(self.dropdown_id)).text)
